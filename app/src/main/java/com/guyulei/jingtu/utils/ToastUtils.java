package com.guyulei.jingtu.utils;
...
import com.guyulei.jingtu.ui.base.JingTuApp;
...
public final class ToastUtils {
    ...
    private static int yOffset         = (int) (64 * JingTuApp.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate = (LayoutInflater) JingTuApp.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(@StringRes int resId, int duration) {
        show(JingTuApp.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(JingTuApp.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(JingTuApp.getContext());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(JingTuApp.getContext(), spannableString, duration);
            } else {
                sToast = Toast.makeText(JingTuApp.getContext(), text, duration);
            }
        }
